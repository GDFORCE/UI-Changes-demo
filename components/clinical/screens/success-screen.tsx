...
export function SuccessScreen({ onGoToSignIn }: SuccessScreenProps) {
  return (
    <div className="h-full flex flex-col bg-card items-center justify-center px-6">
      {/* Success Icon */}
      <div className="w-36 h-36 bg-success/15 rounded-full flex items-center justify-center mb-6">
